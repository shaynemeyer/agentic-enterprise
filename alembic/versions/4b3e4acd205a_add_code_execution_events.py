"""add code_execution_events

Revision ID: 4b3e4acd205a
Revises: 6e8da6865934
Create Date: 2026-09-11 06:49:01.762823
...
revision: str = '4b3e4acd205a'
down_revision: Union[str, Sequence[str], None] = '6e8da6865934'
...
def upgrade() -> None:
    ...
    op.create_table('code_execution_events',
...
def downgrade() -> None:
    ...
    op.drop_table('code_execution_events')
    # ### end Alembic commands ###
